...
local function createScoreboardPanel()
	...
	function menu.Credits:Paint(w, h)
		...
		draw.ShadowText(tostring(GAMEMODE.Version || "error") .. ", modified by HeckinChloe, maintained by DataNext and others", "RobotoHUD-L12", 4 + tw + 24, h  * 0.9, Color(220, 220, 220), 0, 4)
	end
